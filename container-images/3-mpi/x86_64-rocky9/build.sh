...
name=e4s-mpi-$target-rocky9-x86_64
timestamp=$(date +%s)

builder_source_image=${RUNNER_SOURCE_IMAGE:-$ROCKY_X86_64_RUNNER_IMAGE}

cuda_source_image=${CUDA_SOURCE_IMAGE:-$ROCKY_X86_64_CUDA_IMAGE}
