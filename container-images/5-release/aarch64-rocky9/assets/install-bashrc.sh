...
export DYNINST_LIB_PATH=$DYNINST_PATH/lib64
...
module use $SPACK_CORE_ROOT/share/spack/modules/linux-rocky9-aarch64_v3
module use ~/spack/share/spack/modules/linux-rocky9-aarch64_v3
