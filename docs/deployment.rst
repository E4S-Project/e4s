...
.. code-block:: console
    ...
    $perlmutter> module load e4s/22.05/mvapich2-3.0a
   ...
   adios/1.13.1                 datatransferkit/3.1-rc3        kokkos-kernels/3.6.00-cuda80    parsec/3.0.2012              scr/3.0rc2
   adios2/2.8.0-cuda80          dyninst/12.1.0-openmp          lammps/20220107-openmp          petsc/3.17.1-cuda80          slate/2021.05.02-cuda80-openmp
   adios2/2.8.0          (D)    faodel/1.2108.1                libquo/1.3.1                    petsc/3.17.1          (D)    slate/2021.05.02-openmp        (D)
   amrex/22.05                  fortrilinos/2.0.0              mercury/2.1.0                   precice/2.4.0                slepc/3.17.1-cuda80
   arborx/1.2                   globalarrays/5.8               metall/0.20                     pumi/2.2.7                   slepc/3.17.1                   (D)
   axom/0.6.1-openmp            hdf5/1.10.7                    mfem/4.4.0                      py-cinemasci/1.7.0           strumpack/6.3.1-openmp
   butterflypack/2.1.1          heffte/2.2.0-cuda80            nccmp/1.9.0.1                   py-libensemble/0.9.1         sundials/6.2.0
   cabana/0.4.0                 heffte/2.2.0            (D)    nco/5.0.1                       py-petsc4py/3.17.1           tasmanian/7.7-openmp
   caliper/2.7.0-cuda80         hpx/1.7.1-cuda80               omega-h/9.34.1                  py-warpx/22.05-dims2         tau/2.31.1-cuda
   caliper/2.7.0         (D)    hpx/1.7.1               (D)    openpmd-api/0.14.4              py-warpx/22.05-dims3         trilinos/13.0.1
   darshan-runtime/3.3.1        hypre/2.24.0                   papyrus/1.0.2                   py-warpx/22.05-dimsRZ (D)    veloc/1.5
   
   ---------------------------- /global/cfs/cdirs/m3896/shared/ParaTools/E4S/22.05/mvapich2-3.0a-slurm/spack/share/spack/lmod/cray-sles15-x86_64/Core -----------------------------
   aml/0.1.0            cmake/3.23.1          (D)    ginkgo/1.4.0-cuda80-openmp          legion/21.03.0-cuda80-cuda        nvhpc/22.3             raja/0.14.0-cuda80-openmp
   archer/2.0.0         darshan-util/3.3.1           ginkgo/1.4.0-openmp          (D)    legion/21.03.0             (D)    papi/6.0.0.1-cuda      superlu/5.3.0
   argobots/1.1         flit/2.1.0                   gmp/6.2.1                           magma/2.6.2-cuda80                pdt/3.25.1             swig/4.0.2-fortran
   bolt/2.0             flux-core/0.38.0-cuda        gotcha/1.0.3                        mpark-variant/1.4.0               plasma/21.8.29         umap/2.1.0
   chai/2.4.0           flux-core/0.38.0      (D)    kokkos-kernels/3.6.00-openmp (D)    mvapich2/3.0a                     py-jupyterhub/1.4.1    zfp/0.5.5-cuda80
   charliecloud/0.26    gasnet/2022.3.0              kokkos/3.6.00-openmp
